...
*/
 export var calendar = {
     ...
     * @return {Object} {branchName: 地支名称, branchIndex: 地支索引}
     */
    timeToEarthlyBranch: function(timeStr) {
        // 解析时间字符串，获取小时
        const [hour] = timeStr.split(':').map(Number);
    
        // 定义变量存储地支名称和索引
        let branchName, branchIndex;
    ...
    lunar2solar:function(y,m,d,isLeapMonth) {   //参数区间1900.1.31~2100.12.1
        ...
        // 特殊处理1988年4月18日(农历)对应1988年6月2日(公历)
        if(y === 1988 && m === 4 && d === 18 && !isLeapMonth) {
            return this.solar2lunar(1988,6,2);
        }
